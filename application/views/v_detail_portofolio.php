          ...
          <div class="blog-posts classic-view">
            <div class="post">
              <div class="box text-center">
                ...
                <figure class="main"><img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" alt="" /></figure>
        ...
        <aside class="col-sm-4 sidebar">
          ...
          <div class="sidebox widget">
            ...
            <ul class="post-list">
              ...
              <li>
                <div class="icon-overlay"> <a href="<?php echo base_url().'Home/'.$row->tulisan_slug;?>"><img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" alt="" /> </a> </div>
                <div class="meta">
                  <h5><a href="<?php echo base_url().'Home/'.$row->tulisan_slug;?>"><?php echo $row->tulisan_judul;?></a></h5>
