<?php
	class M_tentang extends CI_Model{
		...
		function get_all_tentang(){
			$hsl=$this->db->query("SELECT tbl_tentang.*,DATE_FORMAT(tentang_tanggal,'%d/%m/%Y') AS tanggal,kategori_tentang_nama FROM tbl_tentang join tbl_kategori_tentang on tentang_kategori_id=kategori_tentang_id ORDER BY tentang_id DESC");
			return $hsl;
		}
		...
		function simpan_tentang($nama,$jabatan,$bijak,$gambar,$option1,$option2,$kategori){
		...
		function update_tentang($tentang_id,$nama,$jabatan,$bijak,$gambar,$option1,$option2,$kategori){
		...
		function update_tentang_tnp_img($tentang_id,$nama,$jabatan,$bijak,$option1,$option2,$kategori){
			$hsl=$this->db->query("UPDATE tbl_tentang SET tentang_nama='$nama',tentang_jabatan='$jabatan',tentang_bijak='$bijak',link_option_1='$option1',link_option_2='$option2', tentang_kategori_id='$kategori' WHERE tentang_id='$tentang_id'");
			return $hsl;
		}
