$(document).ready(function() {
    ...
    var instagramFeed = new Instafeed({
        ...
        limit: 10,
        userId: 5501157094,
        accessToken: '5501157094.1677ed0.16e7e946039640d987df20de9188def7',
        resolution: 'low_resolution',
        template: '<div class="item"><figure class="icon-overlay"><a href="{{link}}" target="blank"><img src="{{image}}" /></a></figure></div>',
        after: function() {
